...
import {
  ...
  // them is wrong.
  DECOMPOSE_WEB_ASK,
  // The both-empty carve-out, shared for the same reason: tako_search's
  // equivalent branch used to end at "stop calling Tako" while this one allowed
  // one narrower web attempt, so the two tools disagreed on the identical
  // situation.
