...
export const KnowledgeCardMethodology = z.object({ "methodology_name": z.union([z.string(), z.null()]).describe("The name of the methodology"), "methodology_description": z.union([z.string(), z.null()]).describe("A concise, one-sentence summary of the methodology (source and what is measured). Falls back to the full methodology text when no concise summary is available.") });
