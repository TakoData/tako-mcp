...
// stays runnable locally.
{
  ...
  if (listRes.status === 401) {
    ...
    // tako_graph_related became default in the allowlist pass, so it is listed
    // on the anonymous surface (the listing is auth-invariant, spec D4) but
    // remains outside FREE_TIER_TOOL_NAMES and must answer sign-in at dispatch.
