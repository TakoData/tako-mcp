...
* regenerate schemas + registry from synced spec ([7362445](https://github.com/TakoData/tako-mcp/commit/73624450c9f0c0a809d0d316b8740d87fbee09cb))
* sync OpenAPI spec from monorepo ([ad23c43](https://github.com/TakoData/tako-mcp/commit/ad23c4389dc9e8157f6f440d2fb7c65a558ac492))
* sync OpenAPI spec from TakoData/tako ([9a8e32f](https://github.com/TakoData/tako-mcp/commit/9a8e32fdfec855dda0fff91813427382f5aefee5))

## [1.1.6](https://github.com/TakoData/tako-mcp/compare/v1.1.5...v1.1.6) (2026-09-23)


### Chores

* regenerate schemas + registry from synced spec ([60651fd](https://github.com/TakoData/tako-mcp/commit/60651fd9022d80672f24adc5ea85e87ad1046397))
* regenerate schemas + registry from synced spec ([299dcc8](https://github.com/TakoData/tako-mcp/commit/299dcc81be96f6e327e511105cbe36daa6d3da49))
* sync OpenAPI spec from monorepo ([4c0faba](https://github.com/TakoData/tako-mcp/commit/4c0faba857a6f4aa30dc3d3e027777c9f1c4858a))
* sync OpenAPI spec from monorepo ([49b63d2](https://github.com/TakoData/tako-mcp/commit/49b63d28bab4737cb869b93c97e7b864f8e80ac8))
* sync OpenAPI spec from TakoData/tako ([db19f94](https://github.com/TakoData/tako-mcp/commit/db19f949a92e20e881528b38c745afa7487f1f94))
* sync OpenAPI spec from TakoData/tako ([71988df](https://github.com/TakoData/tako-mcp/commit/71988df93104c7fb1cf4c804ed3b3bb46646e222))

## [1.1.5](https://github.com/TakoData/tako-mcp/compare/v1.1.4...v1.1.5) (2026-09-11)


### Chores

* sync OpenAPI spec from monorepo ([#301](https://github.com/TakoData/tako-mcp/issues/301)) ([08d5f81](https://github.com/TakoData/tako-mcp/commit/08d5f817e6f02f2f5eead0e594f15d6c30193c55))
...
* **instructions:** the test pinned the answer, and one surface kept arguing ([64b31ed](https://github.com/TakoData/tako-mcp/commit/64b31edde01b952414a68d58111926935207333b))
* **mcp:** the instructions conceded the web search they meant to replace ([d74ef97](https://github.com/TakoData/tako-mcp/commit/d74ef97ec484cd1d29edac0ecdf7ab2a30d2774f))
* **skills:** the hedge outlived its removal in a copy nothing diffed ([40d12f2](https://github.com/TakoData/tako-mcp/commit/40d12f28987956aed65e1852af6235865cdb3f14))
* **widget:** the reloaded card had a chart, and we picked the wreckage ([a19f2ec](https://github.com/TakoData/tako-mcp/commit/a19f2ecb3600e8a3529e61b1882f63e41ff41cb0))


### Chores

* regenerate schemas + registry from synced spec ([6185ebe](https://github.com/TakoData/tako-mcp/commit/6185ebec822d0c1149f41630f195bb5ba8d9fa39))
* sync OpenAPI spec from monorepo ([f4ea748](https://github.com/TakoData/tako-mcp/commit/f4ea748971251327465da13704c9b302cd38589b))
* sync OpenAPI spec from TakoData/tako ([409db58](https://github.com/TakoData/tako-mcp/commit/409db58fab165031d8c921261d362ad5ef8cc43e))
